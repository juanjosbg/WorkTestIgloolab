...
define( 'DB_NAME', 'bwamrati3dyrl3chebx1' );

/** Database username */
define( 'DB_USER', 'ulo2tulhavvej4o2' );

/** Database password */
define( 'DB_PASSWORD', 'xOMSx3Mtjp3HLyweMhXS' );

/** Database hostname */
define( 'DB_HOST', 'bwamrati3dyrl3chebx1-mysql.services.clever-cloud.com' );
